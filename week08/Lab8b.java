...
public class Lab8b {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// New line for Lab8b
			System.out.println("The following numbers were duplicated in the ArrayList: " + dups(num) + ".");
	...
	// Start of dups()
	public static ArrayList<Integer> dups(ArrayList<Integer>num) {
		ArrayList<Integer> duplicates = new ArrayList<Integer>();
		int i = 1;
		for(int object : num) {
			if(num.subList(i, num.size()).contains(object) && !duplicates.contains(object)) {
